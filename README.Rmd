...
statistical significance measures: the Z-test, and the LMP (Lancaster’s Mid-P) test, and

practical significance measures: the h-statistic, the Phi-coefficient, the SF (ShortFall) statistic, and the impact ratio.
